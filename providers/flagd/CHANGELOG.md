...
## [0.7.0](https://github.com/erka/go-sdk-contrib/compare/providers/flagd/v0.6.0...providers/flagd/v0.7.0) (2026-07-10)


### ⚠ BREAKING CHANGES

* DISABLED is a successful evaluation (still defaults) ([#896](https://github.com/erka/go-sdk-contrib/issues/896))
* fractional bucketing improvements ([#866](https://github.com/erka/go-sdk-contrib/issues/866))
* add graceful defaulting to code defaults ([#841](https://github.com/erka/go-sdk-contrib/issues/841))
* **flagd:** add file mode to flagd provider ([#648](https://github.com/erka/go-sdk-contrib/issues/648))
* use new eval/sync protos (requires flagd v0.7.3+) ([#451](https://github.com/erka/go-sdk-contrib/issues/451))
...
* **deps:** Remove dependency on sigs.k8s.io/controller-runtime/pkg/lo… ([#639](https://github.com/erka/go-sdk-contrib/issues/639)) ([c2e1a73](https://github.com/erka/go-sdk-contrib/commit/c2e1a73e5d4297625b048b1a589101150b7c4136))
* **deps:** update golang.org/x/exp digest to 1b97071 ([#379](https://github.com/erka/go-sdk-contrib/issues/379)) ([d2b2f1e](https://github.com/erka/go-sdk-contrib/commit/d2b2f1e19d5d6e9168174dc2d0196453a57ecac1))
* **deps:** update golang.org/x/exp digest to 7e4ce0a ([#515](https://github.com/erka/go-sdk-contrib/issues/515)) ([4a04445](https://github.com/erka/go-sdk-contrib/commit/4a04445ee4e327bc0cfe497f0d7bab64697b8b61))
* **deps:** update golang.org/x/exp digest to 814bf88 ([#453](https://github.com/erka/go-sdk-contrib/issues/453)) ([80cdaaa](https://github.com/erka/go-sdk-contrib/commit/80cdaaa9fa5ffa25eee3dd0de98588ad66aa5f2e))
* **deps:** update golang.org/x/exp digest to a685a6e ([#479](https://github.com/erka/go-sdk-contrib/issues/479)) ([e55c610](https://github.com/erka/go-sdk-contrib/commit/e55c610e419589d9bfc3a90089391cbe615d71c7))
* **deps:** update golang.org/x/exp digest to b7579e2 ([#679](https://github.com/erka/go-sdk-contrib/issues/679)) ([a6372f9](https://github.com/erka/go-sdk-contrib/commit/a6372f91b262d2f81b90bfa9e76d722ad480378b))
* **deps:** update jsonlogic module to fix race detection ([#691](https://github.com/erka/go-sdk-contrib/issues/691)) ([21f3de0](https://github.com/erka/go-sdk-contrib/commit/21f3de0d39a6d23000957bd6f278df466af385e4))
* **deps:** update module buf.build/gen/go/open-feature/flagd/bufbuild/connect-go to v1.5.2-20230710190440-2333a9579c1a.1 ([#260](https://github.com/erka/go-sdk-contrib/issues/260)) ([35d2774](https://github.com/erka/go-sdk-contrib/commit/35d277438add84d139dbc416e0a9e180eade7ed2))
* **deps:** update module buf.build/gen/go/open-feature/flagd/connectrpc/go to v1.16.2-20240215170432-1e611e2999cc.1 ([#518](https://github.com/erka/go-sdk-contrib/issues/518)) ([44965d6](https://github.com/erka/go-sdk-contrib/commit/44965d69e5a2ff3621ba9de51d140ad0ea94bdfc))
* **deps:** update module buf.build/gen/go/open-feature/flagd/connectrpc/go to v1.17.0-20240906125204-0a6a901b42e8.1 ([#581](https://github.com/erka/go-sdk-contrib/issues/581)) ([51238a0](https://github.com/erka/go-sdk-contrib/commit/51238a0b37344077529ad1e0223d6eeca3c2752c))
* **deps:** update module buf.build/gen/go/open-feature/flagd/connectrpc/go to v1.18.1-20250127221518-be6d1143b690.1 ([#605](https://github.com/erka/go-sdk-contrib/issues/605)) ([6ff206c](https://github.com/erka/go-sdk-contrib/commit/6ff206c11517e168d864e24fc1ad28f672599a1f))
* **deps:** update module buf.build/gen/go/open-feature/flagd/connectrpc/go to v1.18.1-20250529171031-ebdc14163473.1 ([#699](https://github.com/erka/go-sdk-contrib/issues/699)) ([6c7044d](https://github.com/erka/go-sdk-contrib/commit/6c7044de8bf10d12ed07f4c66335e297c444a6fe))
* **deps:** update module buf.build/gen/go/open-feature/flagd/grpc/go to v1.5.1-20240215170432-1e611e2999cc.1 ([#512](https://github.com/erka/go-sdk-contrib/issues/512)) ([1c765e5](https://github.com/erka/go-sdk-contrib/commit/1c765e5db0f9129f2be44ffdf7ac212283bb0f6c))
* **deps:** update module buf.build/gen/go/open-feature/flagd/grpc/go to v1.5.1-20250529171031-ebdc14163473.2 ([#700](https://github.com/erka/go-sdk-contrib/issues/700)) ([4747395](https://github.com/erka/go-sdk-contrib/commit/474739580f3c7f72e031929b99ab0b86ba4812bb))
* **deps:** update module buf.build/gen/go/open-feature/flagd/protocolbuffers/go to v1.33.0-20240215170432-1e611e2999cc.1 ([#468](https://github.com/erka/go-sdk-contrib/issues/468)) ([aebf9d0](https://github.com/erka/go-sdk-contrib/commit/aebf9d0a7cc514f66dc26d50104bc4656408cb44))
* **deps:** update module buf.build/gen/go/open-feature/flagd/protocolbuffers/go to v1.36.6-20250127221518-be6d1143b690.1 ([#663](https://github.com/erka/go-sdk-contrib/issues/663)) ([665759d](https://github.com/erka/go-sdk-contrib/commit/665759d7ef1bc00aa5db9b658c7cfc135f3c7ea0))
* **deps:** update module buf.build/gen/go/open-feature/flagd/protocolbuffers/go to v1.36.6-20250529171031-ebdc14163473.1 ([#706](https://github.com/erka/go-sdk-contrib/issues/706)) ([902021b](https://github.com/erka/go-sdk-contrib/commit/902021be1083336d9a53c1fd8388cbaaa8dc7959))
* **deps:** update module connectrpc.com/connect to v1.14.0 ([#412](https://github.com/erka/go-sdk-contrib/issues/412)) ([f1ea55f](https://github.com/erka/go-sdk-contrib/commit/f1ea55feee1773f2582f8074044b36ca51480f36))
* **deps:** update module connectrpc.com/otelconnect to v0.7.0 ([#422](https://github.com/erka/go-sdk-contrib/issues/422)) ([a7a1540](https://github.com/erka/go-sdk-contrib/commit/a7a1540003298968b86b90ecfb80062e2a6f3671))
* **deps:** update module connectrpc.com/otelconnect to v0.7.1 ([#558](https://github.com/erka/go-sdk-contrib/issues/558)) ([423790c](https://github.com/erka/go-sdk-contrib/commit/423790c1b45e32e786f5977f67701ae98d7d1c45))
* **deps:** update module connectrpc.com/otelconnect to v0.7.2 ([#664](https://github.com/erka/go-sdk-contrib/issues/664)) ([7762020](https://github.com/erka/go-sdk-contrib/commit/7762020a6f74dcc4d2e1dadc37b51d57ae589e01))
* **deps:** update module github.com/bufbuild/connect-go to v1.10.0 ([#284](https://github.com/erka/go-sdk-contrib/issues/284)) ([a6a67b0](https://github.com/erka/go-sdk-contrib/commit/a6a67b01c0441b4cb4881945109265bd6d9e8cd6))
* **deps:** update module github.com/cucumber/godog to v0.14.1 ([#513](https://github.com/erka/go-sdk-contrib/issues/513)) ([f15f019](https://github.com/erka/go-sdk-contrib/commit/f15f01969ea0537f66592a77870a68b0de5fd7cc))
* **deps:** update module github.com/cucumber/godog to v0.15.0 ([#632](https://github.com/erka/go-sdk-contrib/issues/632)) ([210e397](https://github.com/erka/go-sdk-contrib/commit/210e3970e676d5144e50e1dc602b55d198bbddfa))
* **deps:** update module github.com/go-logr/logr to v1.3.0 ([#361](https://github.com/erka/go-sdk-contrib/issues/361)) ([d29fe69](https://github.com/erka/go-sdk-contrib/commit/d29fe69424c9a22f89a4147b70be090a1716981c))
* **deps:** update module github.com/go-logr/logr to v1.4.1 ([#415](https://github.com/erka/go-sdk-contrib/issues/415)) ([77c597f](https://github.com/erka/go-sdk-contrib/commit/77c597f6d660b0c9920b809183aa9bb9fadf6238))
* **deps:** update module github.com/google/go-cmp to v0.6.0 ([#354](https://github.com/erka/go-sdk-contrib/issues/354)) ([dde96df](https://github.com/erka/go-sdk-contrib/commit/dde96df31dc96629857e1866c026236c1c4a1843))
* **deps:** update module github.com/google/go-cmp to v0.7.0 ([#675](https://github.com/erka/go-sdk-contrib/issues/675)) ([b435fb4](https://github.com/erka/go-sdk-contrib/commit/b435fb47b3c31d5518079e4f8ed2edf4c8ff23ff))
* **deps:** update module github.com/hashicorp/golang-lru/v2 to v2.0.4 ([#233](https://github.com/erka/go-sdk-contrib/issues/233)) ([dc053d0](https://github.com/erka/go-sdk-contrib/commit/dc053d05d49ab4500b443dd5c933a9feaec1ca6a))
* **deps:** update module github.com/hashicorp/golang-lru/v2 to v2.0.7 ([#312](https://github.com/erka/go-sdk-contrib/issues/312)) ([cd2a830](https://github.com/erka/go-sdk-contrib/commit/cd2a83044ff88087a2d8ea03632e876b1cf00bd0))
* **deps:** update module github.com/open-feature/flagd/core to v0.11.5 ([#666](https://github.com/erka/go-sdk-contrib/issues/666)) ([94b44c4](https://github.com/erka/go-sdk-contrib/commit/94b44c4aed982ac54b91bd82a2cf8400c1b622c0))
* **deps:** update module github.com/open-feature/flagd/core to v0.5.4 ([#235](https://github.com/erka/go-sdk-contrib/issues/235)) ([b908b07](https://github.com/erka/go-sdk-contrib/commit/b908b07b7f73a345bd8aed1e85050e2e7fa0a878))
* **deps:** update module github.com/open-feature/flagd/core to v0.6.0 ([#259](https://github.com/erka/go-sdk-contrib/issues/259)) ([3121c53](https://github.com/erka/go-sdk-contrib/commit/3121c5388f24614d7131cfc5ff47402faa6e64b5))
* **deps:** update module github.com/open-feature/flagd/core to v0.6.2 ([#286](https://github.com/erka/go-sdk-contrib/issues/286)) ([6290121](https://github.com/erka/go-sdk-contrib/commit/62901210bda2aa62333b6648ae9ab9dad9612d48))
* **deps:** update module github.com/open-feature/flagd/core to v0.6.6 ([#307](https://github.com/erka/go-sdk-contrib/issues/307)) ([b735aa8](https://github.com/erka/go-sdk-contrib/commit/b735aa849dfc63bbea0dcacffeb089390d91c782))
* **deps:** update module github.com/open-feature/flagd/core to v0.6.7 ([#350](https://github.com/erka/go-sdk-contrib/issues/350)) ([8bccc11](https://github.com/erka/go-sdk-contrib/commit/8bccc119f0f454adb3aa35e5c74bff43c50a80d3))
* **deps:** update module github.com/open-feature/flagd/core to v0.7.4 ([#384](https://github.com/erka/go-sdk-contrib/issues/384)) ([09b4224](https://github.com/erka/go-sdk-contrib/commit/09b42243885c1d74bb1d02d08aa3c5621ede7330))
* **deps:** update module github.com/open-feature/flagd/core to v0.8.1 ([#483](https://github.com/erka/go-sdk-contrib/issues/483)) ([4c3f005](https://github.com/erka/go-sdk-contrib/commit/4c3f005f587902b239ea904c8d050d054dc8afe7))
...
* **deps:** update module github.com/open-feature/go-sdk-contrib/tests/flagd to v1.4.1 ([#484](https://github.com/erka/go-sdk-contrib/issues/484)) ([6f4e7b7](https://github.com/erka/go-sdk-contrib/commit/6f4e7b746e8854b999ec6ece6a8259a5c9e77fdc))
* **deps:** update module go.uber.org/mock to v0.4.0 ([#425](https://github.com/erka/go-sdk-contrib/issues/425)) ([91f70c0](https://github.com/erka/go-sdk-contrib/commit/91f70c0dba1e1ff8d7214b05de8b86eead43a922))
* **deps:** update module go.uber.org/mock to v0.5.2 ([#667](https://github.com/erka/go-sdk-contrib/issues/667)) ([b609a70](https://github.com/erka/go-sdk-contrib/commit/b609a7089307f92cb4e43477f3f98736f7a6d2d2))
* **deps:** update module golang.org/x/net to v0.12.0 ([#240](https://github.com/erka/go-sdk-contrib/issues/240)) ([b4b161e](https://github.com/erka/go-sdk-contrib/commit/b4b161ecb8e135fe90215e63696bb664ed06b161))
* **deps:** update module golang.org/x/net to v0.17.0 [security] ([#347](https://github.com/erka/go-sdk-contrib/issues/347)) ([a05689c](https://github.com/erka/go-sdk-contrib/commit/a05689cba2cea78c4741ae0e6a096fa370970b9c))
* **deps:** update module golang.org/x/net to v0.33.0 [security] ([#601](https://github.com/erka/go-sdk-contrib/issues/601)) ([947cd3f](https://github.com/erka/go-sdk-contrib/commit/947cd3f07c32ea91fd089340db55fd407a7072a5))
* **deps:** update module golang.org/x/net to v0.38.0 [security] ([#649](https://github.com/erka/go-sdk-contrib/issues/649)) ([0ccc7e3](https://github.com/erka/go-sdk-contrib/commit/0ccc7e36044e90e7972505651ac8dfbc6680c49c))
* **deps:** update module google.golang.org/grpc to v1.62.1 ([#430](https://github.com/erka/go-sdk-contrib/issues/430)) ([c20613c](https://github.com/erka/go-sdk-contrib/commit/c20613c5079f2a9871c451771aca2b8ab56d7bcb))
* **deps:** update module google.golang.org/protobuf to v1.31.0 ([#249](https://github.com/erka/go-sdk-contrib/issues/249)) ([909b0b7](https://github.com/erka/go-sdk-contrib/commit/909b0b73fca87f5f0f374ff299eae4f7fa884f5d))
* **deps:** update module sigs.k8s.io/controller-runtime to v0.17.2 ([#434](https://github.com/erka/go-sdk-contrib/issues/434)) ([acaf0cb](https://github.com/erka/go-sdk-contrib/commit/acaf0cb8c479ff6978be4753cc192fdaac077ecb))
...
* fix goroutine leaks around shutdown ([#716](https://github.com/erka/go-sdk-contrib/issues/716)) ([c3ea532](https://github.com/erka/go-sdk-contrib/commit/c3ea53271ed91d20c9a9afd762ea5e2c4c3c488a))
...
* **flagd:** Fixed possible nil pointer exception with svcMetadata in service.go ([#634](https://github.com/erka/go-sdk-contrib/issues/634)) ([50256e9](https://github.com/erka/go-sdk-contrib/commit/50256e9af89201ca09f3989161afd5a069d3a06e))
* **flagd:** missed error events, add e2e tests ([#760](https://github.com/erka/go-sdk-contrib/issues/760)) ([3750972](https://github.com/erka/go-sdk-contrib/commit/3750972d25d847ea56f6b9b5a7640407db67ab11))
* **flagd:** resolve data race in InProcess service ([#903](https://github.com/erka/go-sdk-contrib/issues/903)) ([e277fa8](https://github.com/erka/go-sdk-contrib/commit/e277fa8f6dc5b8e2e311139ffa302a9bebb106fa))
* **flagd:** update flagd/core and remove vulnerable dependencies [security] ([#815](https://github.com/erka/go-sdk-contrib/issues/815)) ([f4adcf8](https://github.com/erka/go-sdk-contrib/commit/f4adcf8ac237f57a41c39765fade17cf512b644e))
...
* improvements to the shutdown of provider & support go 1.20 ([#442](https://github.com/erka/go-sdk-contrib/issues/442)) ([6056a8a](https://github.com/erka/go-sdk-contrib/commit/6056a8a6854d486a476ccd581ca4570148e1e025))
* nil client causes panic ([#408](https://github.com/erka/go-sdk-contrib/issues/408)) ([74df958](https://github.com/erka/go-sdk-contrib/commit/74df9580ee627a5eb15427c9888b72ca10bf57e8))
* **security:** update module github.com/containerd/containerd/v2 to v2.1.5 [security] ([#797](https://github.com/erka/go-sdk-contrib/issues/797)) ([f74c0c3](https://github.com/erka/go-sdk-contrib/commit/f74c0c306759914c48364320f2f3a2db252f3d35))
* **security:** update module github.com/containerd/containerd/v2 to v2.2.5 [security] ([#905](https://github.com/erka/go-sdk-contrib/issues/905)) ([d09a6ab](https://github.com/erka/go-sdk-contrib/commit/d09a6ab662a6910811f7ba623c0a5ae3578287d9))
...
* **security:** update module github.com/moby/buildkit to v0.28.1 [security] ([#853](https://github.com/erka/go-sdk-contrib/issues/853)) ([bd84e61](https://github.com/erka/go-sdk-contrib/commit/bd84e61344106b13805c3036c4b9a01ca8d53529))
...
* **security:** update module golang.org/x/crypto to v0.45.0 [security] ([#803](https://github.com/erka/go-sdk-contrib/issues/803)) ([20b0ccd](https://github.com/erka/go-sdk-contrib/commit/20b0ccdf1261cacde5273f61882194b92dbd6650))
* **security:** update vulnerability-updates [security] ([#724](https://github.com/erka/go-sdk-contrib/issues/724)) ([629a535](https://github.com/erka/go-sdk-contrib/commit/629a5351c2c4b8fed00522f7453d5545920ceaaf))
* **security:** update vulnerability-updates [security] ([#773](https://github.com/erka/go-sdk-contrib/issues/773)) ([21628dc](https://github.com/erka/go-sdk-contrib/commit/21628dc0bc058c042f14c1afa45df2dfc3d93c72))
* **security:** update vulnerability-updates [security] ([#865](https://github.com/erka/go-sdk-contrib/issues/865)) ([9f0e819](https://github.com/erka/go-sdk-contrib/commit/9f0e819d2792297f70bfadabcd95ffe8ae510ab7))
* tests/flagd version to get module correctly ([#813](https://github.com/erka/go-sdk-contrib/issues/813)) ([a32c55f](https://github.com/erka/go-sdk-contrib/commit/a32c55f9ced9b6b71517c1e53b5654942e41c8b5))
...
* added custom grpc resolver ([#587](https://github.com/erka/go-sdk-contrib/issues/587)) ([e509afa](https://github.com/erka/go-sdk-contrib/commit/e509afa1d0db8f8321d5d4518959c53a1418db8f))
...
* consolidate flagd in-process provider ([#394](https://github.com/erka/go-sdk-contrib/issues/394)) ([5f68c85](https://github.com/erka/go-sdk-contrib/commit/5f68c8520f2e2f480512c764ec39f6ecd0b30d1d))
* Default port to 8015 if in-process resolver is used. [#523](https://github.com/erka/go-sdk-contrib/issues/523) ([#524](https://github.com/erka/go-sdk-contrib/issues/524)) ([7db1ce3](https://github.com/erka/go-sdk-contrib/commit/7db1ce3c579c6e5072059c3159fa12f26e79393e))
...
* flag evaluation metadata ([#278](https://github.com/erka/go-sdk-contrib/issues/278)) ([b0a61cd](https://github.com/erka/go-sdk-contrib/commit/b0a61cde5abcd7ea0bc10ef7c6174fc1be5cb423))
* flagd - make sure provider initialize only once ([#418](https://github.com/erka/go-sdk-contrib/issues/418)) ([c061cf4](https://github.com/erka/go-sdk-contrib/commit/c061cf4ac1e76cfe2aef9af52746fe0c14f6f610))
* flagd add scope to flag metadata ([#420](https://github.com/erka/go-sdk-contrib/issues/420)) ([b3949fe](https://github.com/erka/go-sdk-contrib/commit/b3949fe00318bee037fd2bd4e1655182f1fcdc31))
* flagd offline in-process support with flags sources from file ([#421](https://github.com/erka/go-sdk-contrib/issues/421)) ([8685cc0](https://github.com/erka/go-sdk-contrib/commit/8685cc0c1c4bee83ea38fa76e189c1a10840ec71))
...
* **flagd:** add file mode to flagd provider ([#648](https://github.com/erka/go-sdk-contrib/issues/648)) ([3ac923c](https://github.com/erka/go-sdk-contrib/commit/3ac923c17efb04959297fe8ba9fe1eb923bbbfc1))
* **flagd:** Add flagd-selector gRPC metadata header to in-process service. ([#790](https://github.com/erka/go-sdk-contrib/issues/790)) ([a891ba8](https://github.com/erka/go-sdk-contrib/commit/a891ba8d89b9b4233a7cb222668ead16b1036807))
* **flagd:** add Shutdown support for in-process sync ([#687](https://github.com/erka/go-sdk-contrib/issues/687)) ([ecf95d6](https://github.com/erka/go-sdk-contrib/commit/ecf95d60df95e679d6876795f4c9bffa799857fc))
* **flagd:** Added WithGrpcDialOptionsOverride provider option ([#638](https://github.com/erka/go-sdk-contrib/issues/638)) ([fe904bb](https://github.com/erka/go-sdk-contrib/commit/fe904bb054be86ca8e1cafa8577e8ac152dfefc8))
* **flagd:** Configure in-process provider using FLAGD_SYNC_PORT environment variable ([#804](https://github.com/erka/go-sdk-contrib/issues/804)) ([6cf3902](https://github.com/erka/go-sdk-contrib/commit/6cf3902e31104b0cadd50368fca537b03f390c9c))
* **flagd:** Support supplying providerID for in-process resolver as an option ([#626](https://github.com/erka/go-sdk-contrib/issues/626)) ([2d35083](https://github.com/erka/go-sdk-contrib/commit/2d35083b2491692816f42653d86bbebd31648d1c))
* fractional bucketing improvements ([#866](https://github.com/erka/go-sdk-contrib/issues/866)) ([73d84a6](https://github.com/erka/go-sdk-contrib/commit/73d84a638100815741eb83fad3b1bec785b00411))
...
* improve in-process error mapping ([#440](https://github.com/erka/go-sdk-contrib/issues/440)) ([1dee30b](https://github.com/erka/go-sdk-contrib/commit/1dee30b849fd93694d1945490b7aa53b82669770))
* make use of flagd-selector header in RPC mode ([#895](https://github.com/erka/go-sdk-contrib/issues/895)) ([c513aa1](https://github.com/erka/go-sdk-contrib/commit/c513aa16315dbf870cbe71ecbe5f6c44f1e1b970))
* Support supplying a custom sync provider for in-process flagd ([#598](https://github.com/erka/go-sdk-contrib/issues/598)) ([bfa642a](https://github.com/erka/go-sdk-contrib/commit/bfa642ad3e0726c2e01ad623312d582b0511e100))
* update flagd core along with removal of deprecated methods ([#509](https://github.com/erka/go-sdk-contrib/issues/509)) ([ae16e3b](https://github.com/erka/go-sdk-contrib/commit/ae16e3b18ff5d839c883ae0f0ebe06d68c013290))
* update to latest flagd core release ([#495](https://github.com/erka/go-sdk-contrib/issues/495)) ([4034850](https://github.com/erka/go-sdk-contrib/commit/40348500c7adc433bd2387f43bebcad83ae65153))
* upgrade flagd dependencies to 0.12.1 ([#731](https://github.com/erka/go-sdk-contrib/issues/731)) ([8e8d888](https://github.com/erka/go-sdk-contrib/commit/8e8d888dea080a03ea2a709b79598c7de6a9eed8))
* use new eval/sync protos (requires flagd v0.7.3+) ([#451](https://github.com/erka/go-sdk-contrib/issues/451)) ([308bba1](https://github.com/erka/go-sdk-contrib/commit/308bba1656dfe05993b83bc9f2059082b41e79f0))
